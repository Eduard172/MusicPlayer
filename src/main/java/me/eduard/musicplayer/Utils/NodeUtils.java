...
public class NodeUtils {
    ...
    public static void setNodesOpacity(double opacity, Node... nodes){
        for(Node n : nodes){
    ...
    public static void setNodeViewType(ViewType viewType, Node node){
        switch (viewType){
            ...
            case BEHIND -> node.setViewOrder(1);
        }
    }
    public static void setNodesVisibility(boolean visible, Node... nodes){
        for(Node node : nodes)
