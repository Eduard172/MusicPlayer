...
public class TimeConverter {
    ...
    private long timer;
    public TimeConverter(long timer){
        this.timer = timer;
    }
    ...
    public static String toString(long timer, LevelType levelType, String separator){
        return new TimeConverter(timer).toString(levelType, separator);
    }
    public static String toExplicitString(long timer, LevelType levelType, boolean abbreviations){
    ...
    public String extraConvert(long t){
