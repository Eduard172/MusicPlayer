...
public class ScreenLauncher {
    ...
    public static void launchDeletePlaylistScreen(String selectedPlaylist){
        try {
            ...
            WindowTitleBar titleBar = new WindowTitleBar(stage).useDefaultPresets()
                    .setTitleString("Confirmation await")
    ...
    public static void launchPlannedToRemoveWarning(String additionalMessage, EventHandler<ActionEvent> whenClickedOK){
        try {
            ...
            WindowTitleBar titleBar = new WindowTitleBar(stage).useDefaultPresets()
                    .setTitleString("This feature is planned to be removed")
                    .setTitleLabelStyling("-fx-text-fill: #000000")
                    .setOnClose(() -> MainApp.closeStage(stage, Player.ANIMATIONS))
                    .setButtonsArrangement(WindowTitleBar.ButtonsArrangement.CLOSE)
                    .setSupportStyling(MainApp.childWindowTitleBarTheme);
            ...
            MessageBox_Ok messageBoxOk = fxmlStageBuilder.getFxmlLoader().getController();
            GlobalAppStyle.applyToButtons(messageBoxOk.cancelButton, messageBoxOk.okButton);
