...
public class MoveSongs extends OutputUtilities {
    ...
    public static void launchWindow(String selectedPlaylist){
        try {
            ...
            WindowTitleBar titleBar = new WindowTitleBar(stage).useDefaultPresets()
                    .setTitleString("Move your songs from a playlist to another")
            ...
            GlobalAppStyle.applyToButtons(moveSongs.cancelButton, moveSongs.startTransferButton);
