...
public class PlaylistInfo extends OutputUtilities {
    ...
    public static void launchWindow(String selectedPlaylist){
        try {
            ...
            WindowTitleBar titleBar = new WindowTitleBar(stage).useDefaultPresets()
                    ...
                    .setTitleString("Information about '"+Player.SELECTED_PLAYLIST+"' playlist.")
            ...
            GlobalAppStyle.applyToButtons(playlistInfo.okButton);
