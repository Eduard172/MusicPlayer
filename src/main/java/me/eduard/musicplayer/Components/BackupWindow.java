...
public class BackupWindow extends OutputUtilities {
    ...
    public static void launchWindow(){
        try {
            ...
            GlobalAppStyle.applyToButtons(backupWindow.createBackup, backupWindow.restoreBackup, backupWindow.cancel, backupWindow.browse);
