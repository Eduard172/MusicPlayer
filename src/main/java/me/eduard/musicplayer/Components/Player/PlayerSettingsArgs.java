...
public class PlayerSettingsArgs {
    ...
    private void initValues(){
        ...
        this.hidePlayer = Boolean.parseBoolean(this.playerSettings.getSettingValue("hide-player", false));
        this.hideTitle = Boolean.parseBoolean(this.playerSettings.getSettingValue("hide-title", false));
        this.selectedPlaylist = this.playerSettings.getSettingValue("selected-playlist", false);
