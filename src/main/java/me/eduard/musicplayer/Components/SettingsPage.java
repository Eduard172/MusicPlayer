...
public class SettingsPage extends OutputUtilities implements Initializable {
    ...
    public static void launchWindow(boolean useCached){
        ...
        WindowTitleBar titleBar = new WindowTitleBar(stage).useDefaultPresets()
                .setTitleString("Application Settings")
        ...
        GlobalAppStyle.applyToButtons(settingsPage.cancelButton, settingsPage.saveButton, settingsPage.saveAndExitButton);
        GlobalAppStyle.applyToCheckbox(
                settingsPage.allowAnimations,
                settingsPage.allowSlidingNotification,
                settingsPage.autoStart,
                settingsPage.verboseStatus,
                settingsPage.startInFullScreen,
                settingsPage.hidePlayer,
        ...
        fxmlStageBuilder.addKeyEvents(
                new SimplePair<>(KeyEvent.KEY_RELEASED, event -> KeyCombinationUtils.removeKey(event.getCode())),
                new SimplePair<>(KeyEvent.KEY_PRESSED, eventHandler)
        );
    }
}