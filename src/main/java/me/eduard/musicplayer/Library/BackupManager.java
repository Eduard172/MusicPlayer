...
public class BackupManager {
    ...
    public static void createBackup(File destination, boolean force){
        ...
        WrappedValue<String> currentAbsolutePath = WrappedValue.of(null);
        ...
        WindowsCommands.launchPowershellNotification(
                "Backup created",
                "Your playlists and settings were backed up"
        );
    }
    public static void restoreBackup(File backupDirectory){
        ...
        WindowsCommands.launchPowershellNotification(
                ...
                "Your playlists and settings were successfully restored."
        );
    }
