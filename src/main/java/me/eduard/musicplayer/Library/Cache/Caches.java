...
public class Caches {
    ...
    public static void clearCaches(){
        ...
        synchronized (WindowRegistry.getRegistry()){
            WindowRegistry.getRegistry().forEach((key, val) -> val.close());
        ...
        synchronized (MediaCache.getRegistry()){
            MediaCache.getRegistry().forEach((k, v) -> v.setBoth(null, null));
            MediaCache.clear();
        }
